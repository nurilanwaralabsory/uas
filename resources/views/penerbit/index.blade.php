                                    ...
                                    @foreach ($penerbit as $p)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <h6 class="mb-0 text-sm">{{ $p->alamat }}</h6>
                                            </td>
                                            <td class="align-middle text-center">
                                                <h6 class="mb-0 text-sm">{{ $p->kota }}
                                                </h6>
                                            </td>
                                            <td class="align-middle text-center">
                                                <h6 class="mb-0 text-sm">{{ $p->telepon }}</h6>
                                            </td>
                                            <td class="align-middle text-center">
                                                <a href="/penerbit/{{ $p->id }}/edit">
                                                    <span class="badge badge-sm bg-gradient-warning">Edit</span>
                                                </a>
                                                <form action="penerbit/{{ $p->id }}" method="POST" class="d-inline">
                                                    @method('delete')
                                                    @csrf
