                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        <input type="text" class="form-control" placeholder="Kode" name="kode"
                                            aria-label="Email" aria-describedby="email-addon" value="{{ $penerbit->kode }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label>Nama</label>
                                    <div class="mb-3">
                                        <input type="text" class="form-control" placeholder="Nama" name="nama"
                                            aria-label="Email" aria-describedby="email-addon" value="{{ $penerbit->nama }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label>Alamat</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        <input type="text" class="form-control" placeholder="Kota" name="kota"
                                            aria-label="Email" aria-describedby="email-addon" value="{{ $penerbit->kota }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label>Telepon</label>
